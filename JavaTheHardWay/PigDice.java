...
public class PigDice {
      public static void main(String[] args) {
            ...
            int roll, ptot, ctot, turnTotal, rollOver = 0;
            String choice = "";
            ...
            do {
                  ...
                  do {
                        ...
                        if(roll == 1){
                              ...
                              System.out.print("\tWould you ike to \"roll\" again");
                  ...
                  if(ptot < 100) {
                        ...
                        do{
                            ...
                            if (roll == 1){
                                ...
                                rollOver = turnTotal + ctot;
                                System.out.print(" points so far this round.\n");

                                if(turnTotal < 20 && rollOver < 100){
                                    System.out.println("\tComputer will roll again.");
                                }
                            }
                        } while (roll != 1 && turnTotal < 20 && rollOver < 100);
