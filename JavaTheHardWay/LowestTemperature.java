...
public class LowestTemperature {
      public static void main(String[] args) throws Exception {
            ...
            System.out.println("The lowest average daily temperature was " + lowest + "F (" + fToC(lowest) + "C)");
            System.out.println("The highest average daily temperature was " + highest + "F (" + fToC(highest) + "C)");
      }
